...
function atten(list) {
    ...
    for (let i = 0; i < x; i++) {
        ...
        "<td>"+list[i].total_votes+"</td>"+
        "<td>"+list[i].votes_with_party_pct+"%"+"</td>"+
    "</tr>";
    } 
    return tabla;
}
document.getElementById("party").innerHTML = atten(list);
...
document.getElementById("party2").innerHTML = atten2(list);